...
bool prevSetTimerMode = true; //boolean for determine whether the previous mode we were in so we can tell if we've switched
...
long blinkDelay = 250; //how long in milliseconds the delay will be between LED transitions
